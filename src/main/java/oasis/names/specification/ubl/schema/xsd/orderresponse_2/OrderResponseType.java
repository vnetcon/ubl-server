 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}OrderChangeDocumentReference" maxOccurs="unbounded" minOccurs="0"/>
...
public class OrderResponseType {
    ...
    @XmlElement(name = "OrderChangeDocumentReference", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected List<DocumentReferenceType> orderChangeDocumentReference;
    ...
    /**
     * Sets the value of the orderResponseCode property.
     * 
     * @param value
     *     allowed object is
     *     {@link OrderResponseCodeType }
     ...
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:OrderResponse-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;
     *                      &lt;ccts:ComponentType&gt;ASBIE&lt;/ccts:ComponentType&gt;
     *                      &lt;ccts:DictionaryEntryName&gt;Order Response. Order Change_ Document Reference. Document Reference&lt;/ccts:DictionaryEntryName&gt;
     ...
     * </pre>
     * 
     *                Gets the value of the orderChangeDocumentReference property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orderChangeDocumentReference property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrderChangeDocumentReference().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DocumentReferenceType> getOrderChangeDocumentReference() {
        if (orderChangeDocumentReference == null) {
            orderChangeDocumentReference = new ArrayList<DocumentReferenceType>();
        }
